    ...
    <Card className="sm:col-span-2" x-chunk="dashboard-05-chunk-0">
        <CardHeader className="pb-3">
          ...
          <CardDescription className="max-w-lg text-balance leading-relaxed">
           Enter your Monthly Emmission to see how much you are contributing to the environment
          </CardDescription>
        </CardHeader>
        <CardFooter className="pt-5">
          <Button>Create New Entry <PlusIcon/></Button>
        </CardFooter>
      </Card>
      ...
      <Card x-chunk="dashboard-05-chunk-1">
        <CardHeader className="pb-2">
          ...
          <CardDescription className="flex items-center gap-4 ">  < Trash className="w-4 h-4"/> This Month</CardDescription>
